...
// NOTE: GESTURES[] and NUM_GESTURES are generated by the training notebook into scratch/model.h
...
void loop() {
  ...
  if (maxProb >= gestureConfidenceThreshold && gestureKeys[maxIndex] != '\0') {
